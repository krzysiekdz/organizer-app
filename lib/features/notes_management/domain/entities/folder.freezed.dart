...
mixin _$Folder {
 ...
 String get id; String get name; String? get parentId; String get userId; DateTime get createdAt;
...
@override
int get hashCode => Object.hash(runtimeType,id,name,parentId,userId,createdAt);

@override
String toString() {
  return 'Folder(id: $id, name: $name, parentId: $parentId, userId: $userId, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String name, String? parentId, String userId, DateTime createdAt
});
...
/// Create a copy of Folder
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? parentId = freezed,Object? userId = null,Object? createdAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String? parentId,  String userId,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Folder() when $default != null:
return $default(_that.id,_that.name,_that.parentId,_that.userId,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String? parentId,  String userId,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _Folder():
return $default(_that.id,_that.name,_that.parentId,_that.userId,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String? parentId,  String userId,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _Folder() when $default != null:
return $default(_that.id,_that.name,_that.parentId,_that.userId,_that.createdAt);case _:
  return null;
...
class _Folder extends Folder {
  const _Folder({required this.id, required this.name, this.parentId, required this.userId, required this.createdAt}): super._();
...
/// Create a copy of Folder
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? parentId = freezed,Object? userId = null,Object? createdAt = null,}) {
